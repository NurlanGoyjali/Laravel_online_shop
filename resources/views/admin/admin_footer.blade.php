        ...
        <ul class="dropdown-menu">
            ...
            <li class="active">
                <a class="img-holder switch-trigger" href="javascript:void(0)">
                    <img src="{{asset('admin_assets')}}/assets/img/sidebar-1.jpg" alt="">
                </a>
            </li>
            <li>
                <a class="img-holder switch-trigger" href="javascript:void(0)">
                    <img src="{{asset('admin_assets')}}/assets/img/sidebar-2.jpg" alt="">
                </a>
            </li>
            <li>
                <a class="img-holder switch-trigger" href="javascript:void(0)">
                    <img src="{{asset('admin_assets')}}/assets/img/sidebar-3.jpg" alt="">
                </a>
            </li>
            <li>
                <a class="img-holder switch-trigger" href="javascript:void(0)">
                    <img src="{{asset('admin_assets')}}/assets/img/sidebar-4.jpg" alt="">
                </a>
            </li>
...
<script src="{{asset('admin_assets')}}/assets/js/material-dashboard.js?v=2.1.2" type="text/javascript"></script>
